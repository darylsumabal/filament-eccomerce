...
<div class="flex flex-col items-center justify-center py-4 gap-10 mt-8">
    ...
    <div class="carousel rounded-box w-xs md:w-2xl lg:3xl xl:w-6xl space-x-2 text-[#2A0000]">
        @forelse ($this->items as $item)
            <div class="carousel-item border-2 rounded-md w-xs md:w-64 bg-[#E2D9C8] border-[#e2bf7d] card">
                <div class="p-4 w-full flex h-full flex-col justify-between card-body">
                    <div class="hover-3d">
                        <figure>
                    ...
                    <h2 class="card-title font-black">{{ $item->name }}</h2>

    ...
    <div class="flex min-h-screen flex-col bg-cover bg-center bg-no-repeat items-center"
        ...
        bg-center bg-no-repeat w-full max-w-7xl gap-32">
            <div class="w-full flex text-sm mb-6">
                <div class="hidden w-full md:flex md:px-2">
                    <livewire:nav-bar />
                </div>
            ...
            <div
                class="flex flex-col justify-center w-full  transition-opacity opacity-100 duration-750 text-white gap-6 p-2 xl:p-0">
